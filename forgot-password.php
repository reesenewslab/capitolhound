...
<h1>Forgot Password</h1>";
	...
	echo "
	<form class='form-horizontal col-sm-6 col-sm-offset-3' name='newLostPass' action='".$_SERVER['PHP_SELF']."' method='post'>
		...
		<div class='col-sm-8 col-sm-offset-4'>
			<button class='btn btn-primary btn-lg' type='submit' value='Submit' class='submit'>Submit</button>
		</div>
	</form>
	<div id='bottom'></div>
</div>";
