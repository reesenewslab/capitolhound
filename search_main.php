...
?>
    ...
    <div class="row">		
        <div class="input-group input-group-lg searchbar">
			<input placeholder="Search archives" id="id_q" name="search_term" type="text" value="<?php if($_SERVER['PHP_SELF'] == '/demo.php'){ echo 'healthcare'; }?>" class="form-control"i <?php //if($_SERVER['PHP_SELF'] == '/demo.php'){echo 'readonly=""';}?>/><br/>
