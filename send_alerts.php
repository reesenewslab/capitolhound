...
__HTML__;
    ...
    if ($got_results > 0) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'campaignhound@reesenews.org';
        $mail->Password = 'q9hsuzcVRHcLmiuLQwH8PQ';
        $mail->SMTPSecure = 'tls';

        $mail->From = 'capitolhound@reesenews.org';
        $mail->FromName = 'Capitol Hound';

        $mail->addAddress($email_address);

        $mail->isHTML(true);

        $mail->Subject = "Capitol Hound Email Alert";
        $mail->Body = "$output_email";
