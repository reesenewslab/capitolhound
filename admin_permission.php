...
echo "
<form role='form' class='form-horizontal' name='adminPermission' action='".$_SERVER['PHP_SELF']."?id=".$permissionId."' method='post'>
<table class='table'>
<tr><td>
<h3>Permission Information</h3>
	<div class='form-group'>
		<label class='col-sm-2'>ID:</label>
		<div class='col-sm-10'>".$permissionDetails['id']."</div>
	</div>
	<div class='form-group'>
	...
	<div class='form-group'>
		...
		<div class='col-sm-10'>
			<input class='form-control' type='checkbox' name='delete[".$permissionDetails['id']."]' id='delete[".$permissionDetails['id']."]' value='".$permissionDetails['id']."'>
		</div>
	</div>
</td><td>
